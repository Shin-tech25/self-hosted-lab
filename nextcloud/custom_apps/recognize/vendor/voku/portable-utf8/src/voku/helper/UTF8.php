...
namespace OCA\Recognize\Vendor\voku\helper;
...
final class UTF8
{
     ...
     */
    private static $WHITESPACE_TABLE = ['SPACE' => " ", 'NO-BREAK SPACE' => " ", 'OGHAM SPACE MARK' => " ", 'EN QUAD' => " ", 'EM QUAD' => " ", 'EN SPACE' => " ", 'EM SPACE' => " ", 'THREE-PER-EM SPACE' => " ", 'FOUR-PER-EM SPACE' => " ", 'SIX-PER-EM SPACE' => " ", 'FIGURE SPACE' => " ", 'PUNCTUATION SPACE' => " ", 'THIN SPACE' => " ", 'HAIR SPACE' => " ", 'LINE SEPARATOR' => " ", 'PARAGRAPH SEPARATOR' => " ", 'ZERO WIDTH SPACE' => "​", 'NARROW NO-BREAK SPACE' => " ", 'MEDIUM MATHEMATICAL SPACE' => " ", 'IDEOGRAPHIC SPACE' => "　", 'HALFWIDTH HANGUL FILLER' => "ﾠ"];
    /**
     * @var array
     *
     * @phpstan-var array{upper: string[], lower: string[]}
     */
    private static $COMMON_CASE_FOLD = ['upper' => ['µ', 'ſ', "ͅ", 'ς', 'ẞ', "ϐ", "ϑ", "ϕ", "ϖ", "ϰ", "ϱ", "ϵ", "ẛ", "ι"], 'lower' => ['μ', 's', 'ι', 'σ', 'ß', 'β', 'θ', 'φ', 'π', 'κ', 'ρ', 'ε', "ṡ", 'ι']];
    /**
     * @var array
     *
    ...
    public static function chr_size_list(string $str) : array
    {
        ...
        if (self::$SUPPORT['mbstring_func_overload'] === \true) {
            ...
            return \array_map(static function (string $data) : int {
    ...
    public static function codepoints($arg, bool $use_u_style = \false) : array
    {
        ...
        if ($use_u_style) {
            $arg = \array_map([self::class, 'int_to_hex'], $arg);
        }
     ...
     */
    public static function css_identifier(string $str = '', array $filter = [' ' => '-', '/' => '-', '[' => '', ']' => ''], bool $strip_tags = \false, bool $strtolower = \true) : string
    {
    ...
    public static function encode_mimeheader(string $str, string $from_charset = 'UTF-8', string $to_charset = 'UTF-8', string $transfer_encoding = 'Q', string $linefeed = "\r\n", int $indent = 76)
    {
        ...
        // always fallback via symfony polyfill
        return \iconv_mime_encode('', $str, ['scheme' => $transfer_encoding, 'line-length' => $indent, 'input-charset' => $from_charset, 'output-charset' => $to_charset, 'line-break-chars' => $linefeed]);
    }
    /**
    ...
    public static function getCharDirection(string $char) : string
    {
        if (self::$SUPPORT['intlChar'] === \true) {
            ...
            // from "IntlChar"-Class
            $char_direction = ['RTL' => [1, 13, 14, 15, 21], 'LTR' => [0, 11, 12, 20]];
     ...
     * @psalm-pure
     */
    public static function get_file_type(string $str, array $fallback = ['ext' => null, 'mime' => 'application/octet-stream', 'type' => null]) : array
    {
        if ($str === '') {
            return $fallback;
        }
        ...
        return ['ext' => $ext, 'mime' => $mime, 'type' => $type];
    }
    /**
    ...
    public static function html_encode(string $str, bool $keep_ascii_chars = \false, string $encoding = 'UTF-8') : string
    {
        ...
        if (self::$SUPPORT['mbstring'] === \true) {
            ...
            if ($encoding === 'UTF-8') {
                ...
                $return = \mb_encode_numericentity($str, [$start_code, 0xfffff, 0, 0xfffff]);
                if ($return !== null && $return !== \false) {
                    return $return;
                }
            }
            /** @var false|string|null $return - needed for PhpStan (stubs error) */
            $return = \mb_encode_numericentity($str, [$start_code, 0xfffff, 0, 0xfffff], $encoding);
            if ($return !== null && $return !== \false) {
                return $return;
            }
        }
        ...
        // fallback via vanilla php
        //
        return \implode('', \array_map(static function (string $chr) use($keep_ascii_chars, $encoding) : string {
    ...
    public static function is_url(string $url, bool $disallow_localhost = \false) : bool
    {
        ...
        if ($disallow_localhost) {
            if (self::str_istarts_with_any($url, ['http://localhost', 'https://localhost', 'http://127.0.0.1', 'https://127.0.0.1', 'http://::1', 'https://::1'])) {
                return \false;
            }
     ...
     * @return string
     */
    public static function lcwords(string $str, array $exceptions = [], string $char_list = '', string $encoding = 'UTF-8', bool $clean_utf8 = \false, string $lang = null, bool $try_to_keep_the_string_length = \false) : string
    {
        if (!$str) {
            return '';
        }
    ...
    public static function replace_diamond_question_mark(string $str, string $replacement_char = '', bool $process_invalid_utf8_chars = \true) : string
    {
        ...
        return \str_replace(["�", '�'], [$replacement_char, $replacement_char], $str);
    }
    /**
    ...
    public static function str_titleize(string $str, array $ignore = null, string $encoding = 'UTF-8', bool $clean_utf8 = \false, string $lang = null, bool $try_to_keep_the_string_length = \false, bool $use_trim_first = \true, string $word_define_chars = null) : string
    {
        ...
        $str = (string) \preg_replace_callback('/([^\\s' . $word_define_chars . ']+)/u', static function (array $match) use($try_to_keep_the_string_length, $lang, $ignore, $use_mb_functions, $encoding) : string {
    ...
    public static function str_titleize_for_humans(string $str, array $ignore = [], string $encoding = 'UTF-8') : string
    {
        ...
        $small_words = ['(?<!q&)a', 'an', 'and', 'as', 'at(?!&t)', 'but', 'by', 'en', 'for', 'if', 'in', 'of', 'on', 'or', 'the', 'to', 'v[.]?', 'via', 'vs[.]?'];
        if ($ignore !== []) {
     ...
     * @return string
     */
    public static function ucwords(string $str, array $exceptions = [], string $char_list = '', string $encoding = 'UTF-8', bool $clean_utf8 = \false) : string
    {
        if (!$str) {
            return '';
        }
    ...
    private static function initEmojiData()
    {
        if (self::$EMOJI_KEYS_CACHE === null) {
             ...
             */
            \uksort(self::$EMOJI, static function (string $a, string $b) : int {
    ...
    private static function str_capitalize_name_helper(string $names, string $delimiter, string $encoding = 'UTF-8')
    {
        ...
        $special_cases = ['names' => ['ab', 'af', 'al', 'and', 'ap', 'bint', 'binte', 'da', 'de', 'del', 'den', 'der', 'di', 'dit', 'ibn', 'la', 'mac', 'nic', 'of', 'ter', 'the', 'und', 'van', 'von', 'y', 'zu'], 'prefixes' => ['al-', "d'", 'ff', "l'", 'mac', 'mc', 'nic']];

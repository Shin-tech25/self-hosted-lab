...
use OCA\Recognize\Vendor\Rubix\ML\AnomalyDetectors\LocalOutlierFactor;
use OCA\Recognize\Vendor\Rubix\ML\Exceptions\InvalidArgumentException;
use OCA\Recognize\Vendor\Rubix\ML\Exceptions\RuntimeException;
use OCA\Recognize\Vendor\PHPUnit\Framework\TestCase;
/**
 * @group AnomalyDetectors
 * @covers \OCA\Recognize\Vendor\Rubix\ML\AnomalyDetectors\LocalOutlierFactor
 * @internal
 */
class LocalOutlierFactorTest extends TestCase
{
    ...
    {
        $expected = ['k' => 60, 'contamination' => 0.1, 'tree' => new KDTree()];

...
use OCA\Recognize\Vendor\Rubix\ML\AnomalyDetectors\IsolationForest;
use OCA\Recognize\Vendor\Rubix\ML\Exceptions\InvalidArgumentException;
use OCA\Recognize\Vendor\Rubix\ML\Exceptions\RuntimeException;
use OCA\Recognize\Vendor\PHPUnit\Framework\TestCase;
/**
 * @group AnomalyDetectors
 * @covers \OCA\Recognize\Vendor\Rubix\ML\AnomalyDetectors\IsolationForest
 * @internal
 */
class IsolationForestTest extends TestCase
{
    ...
    {
        $expected = ['estimators' => 300, 'ratio' => 0.2, 'contamination' => 0.1];

...
use OCA\Recognize\Vendor\Rubix\ML\AnomalyDetectors\GaussianMLE;
 ...
 * @covers \OCA\Recognize\Vendor\Rubix\ML\AnomalyDetectors\GaussianMLE
 * @internal
 */
class GaussianMLETest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new GaussianMLE(0.1, 1.0E-8);
    ...
    {
        $expected = ['contamination' => 0.1, 'smoothing' => 1.0E-8];

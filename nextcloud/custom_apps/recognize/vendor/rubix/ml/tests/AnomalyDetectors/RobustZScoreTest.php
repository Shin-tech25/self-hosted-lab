 ...
 * @covers \OCA\Recognize\Vendor\Rubix\ML\AnomalyDetectors\RobustZScore
 * @internal
 */
class RobustZScoreTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new RobustZScore(2.0, 0.5, 1.0E-9);
    ...
    {
        $expected = ['threshold' => 2.0, 'beta' => 0.5, 'smoothing' => 1.0E-9];

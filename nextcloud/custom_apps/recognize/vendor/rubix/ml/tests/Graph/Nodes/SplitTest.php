...
/**
 * @group Nodes
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Graph\Nodes\Split
 * @internal
 */
class SplitTest extends TestCase
{
    ...
    {
        $subsets = [Labeled::quick(self::SAMPLES, self::LABELS), Labeled::quick(self::SAMPLES, self::LABELS)];
    ...
    {
        $expected = [Labeled::quick(self::SAMPLES, self::LABELS), Labeled::quick(self::SAMPLES, self::LABELS)];

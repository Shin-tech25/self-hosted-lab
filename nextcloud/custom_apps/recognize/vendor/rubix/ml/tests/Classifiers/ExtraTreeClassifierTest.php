...
use OCA\Recognize\Vendor\Rubix\ML\Classifiers\ExtraTreeClassifier;
...
/**
 * @group Classifiers
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Classifiers\ExtraTreeClassifier
 * @internal
 */
class ExtraTreeClassifierTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new ExtraTreeClassifier(30, 16, 1.0E-7, 3);
    ...
    {
        $expected = ['max height' => 30, 'max leaf size' => 16, 'min purity increase' => 1.0E-7, 'max features' => 3];

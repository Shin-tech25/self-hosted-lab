...
/**
 * @group Classifiers
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Classifiers\RandomForest
 * @internal
 */
class RandomForestTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new RandomForest(new ClassificationTree(3), 50, 0.2, \true);
    ...
    {
        $expected = ['base' => new ClassificationTree(3), 'estimators' => 50, 'ratio' => 0.2, 'balanced' => \true];

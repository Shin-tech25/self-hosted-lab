...
/**
 * @group Classifiers
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Classifiers\KNearestNeighbors
 * @internal
 */
class KNearestNeighborsTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new KNearestNeighbors(3, \true, new Euclidean());
    ...
    {
        $expected = ['k' => 3, 'weighted' => \true, 'kernel' => new Euclidean()];

...
/**
 * @group Classifiers
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Classifiers\LogisticRegression
 * @internal
 */
class LogisticRegressionTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new LogisticRegression(100, new Adam(0.01), 0.0001, 300, 0.0001, 5, new CrossEntropy());
    ...
    {
        $expected = ['batch size' => 100, 'optimizer' => new Adam(0.01), 'l2 penalty' => 0.0001, 'epochs' => 300, 'min change' => 0.0001, 'window' => 5, 'cost fn' => new CrossEntropy()];

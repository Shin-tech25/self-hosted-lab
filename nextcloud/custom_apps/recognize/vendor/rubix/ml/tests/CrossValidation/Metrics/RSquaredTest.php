...
/**
 * @group Metrics
 * @covers \OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\RSquared
 * @internal
 */
class RSquaredTest extends TestCase
{
    ...
    {
        (yield [[7, 9.5, -20, -500, 0.079], [10, 10.0, 6, -1400, 0.08], 0.48778492125041795]);
        (yield [[0, 0, 0, 0, 0], [10, 10.0, 6, -1400, 0.08], -0.23853547401374797]);
        (yield [[10, 10.0, 6, -1400, 0.08], [10, 10.0, 6, -1400, 0.08], 1.0]);
    }
}

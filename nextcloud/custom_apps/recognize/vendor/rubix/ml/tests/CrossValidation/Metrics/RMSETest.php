...
/**
 * @group Metrics
 * @covers \OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\RMSE
 * @internal
 */
class RMSETest extends TestCase
{
    ...
    {
        (yield [[7, 9.5, -20, -500, 0.079], [10, 10.0, 6, -1400, 0.08], -402.6624516890046]);
        (yield [[0, 0, 0, 0, 0], [10, 10.0, 6, -1400, 0.08], -626.1367273048276]);

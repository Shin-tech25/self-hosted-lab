...
use OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\ProbabilisticAccuracy;
use OCA\Recognize\Vendor\PHPUnit\Framework\TestCase;
use Generator;
/**
 * @group Metrics
 * @covers \OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\ProbabilisticAccuracy
 * @internal
 */
class ProbabilisticAccuracyTest extends TestCase
{
    ...
    {
        (yield [[['U' => 0.7, 'O' => 0.3], ['U' => 0.4, 'O' => 0.6], ['U' => 0.2, 'O' => 0.8]], ['U', 'O', 'U'], 0.5]);
        (yield [[['cat' => 0.6, 'frog' => 0.1, 'hamster' => 0.3], ['cat' => 0.1, 'frog' => 0.7, 'hamster' => 0.2], ['cat' => 0.2, 'frog' => 0.0, 'hamster' => 0.9], ['cat' => 0.5, 'frog' => 0.1, 'hamster' => 0.4], ['cat' => 0.0, 'frog' => 0.8, 'hamster' => 0.2]], ['cat', 'frog', 'hamster', 'cat', 'frog'], 0.7]);
        (yield [[[1 => 0.0, 2 => 0.0, 3 => 1.0], [1 => 0.0, 2 => 1.0, 3 => 0.0], [1 => 1.0, 2 => 0.0, 3 => 0.0]], [3, 2, 1], 1.0]);
        (yield [[[1 => 0.2, 2 => 0.8, 3 => 0.0], [1 => 0.5, 2 => 0.0, 3 => 0.5], [1 => 0.0, 2 => 1.0, 3 => 0.0]], [3, 2, 1], 0.0]);
        (yield [[['yes' => 1.0, 'no' => 0.0], ['yes' => 0.0, 'no' => 1.0]], ['no', 'yes'], 0.0]);

...
/**
 * @group Metrics
 * @covers \OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\MeanSquaredError
 * @internal
 */
class MeanSquaredErrorTest extends TestCase
{
    ...
    {
        (yield [[7, 9.5, -20, -500, 0.079], [10, 10.0, 6, -1400, 0.08], -162137.0500002]);
        (yield [[0, 0, 0, 0, 0], [10, 10.0, 6, -1400, 0.08], -392047.20128000004]);

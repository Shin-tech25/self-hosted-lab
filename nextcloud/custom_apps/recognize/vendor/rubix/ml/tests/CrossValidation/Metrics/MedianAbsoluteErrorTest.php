...
use OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\MedianAbsoluteError;
use OCA\Recognize\Vendor\PHPUnit\Framework\TestCase;
use Generator;
/**
 * @group Metrics
 * @covers \OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\MedianAbsoluteError
 * @internal
 */
class MedianAbsoluteErrorTest extends TestCase
{
    ...
    {
        (yield [[7, 9.5, -20, -500, 0.079], [10, 10.0, 6, -1400, 0.08], -3.0]);
        (yield [[0, 0, 0, 0, 0], [10, 10.0, 6, -1400, 0.08], -10.0]);

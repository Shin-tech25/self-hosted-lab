...
use OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\SMAPE;
use OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\Metric;
use OCA\Recognize\Vendor\PHPUnit\Framework\TestCase;
use Generator;
/**
 * @group Metrics
 * @covers \OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\SMAPE
 * @internal
 */
class SMAPETest extends TestCase
{
    ...
    {
        (yield [[7, 9.5, -20, -500, 0.079], [10, 10.0, 6, -1400, 0.08], -33.641702651574725]);
        (yield [[0, 0, 0, 0, 0], [10, 10.0, 6, -1400, 0.08], -100.0]);

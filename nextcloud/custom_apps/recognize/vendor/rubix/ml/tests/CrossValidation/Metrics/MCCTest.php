...
use OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\MCC;
use OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\Metric;
use OCA\Recognize\Vendor\PHPUnit\Framework\TestCase;
use Generator;
/**
 * @group Metrics
 * @covers \OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\MCC
 * @internal
 */
class MCCTest extends TestCase
{
    ...
    {
        (yield [['wolf', 'lamb', 'wolf', 'lamb', 'wolf'], ['lamb', 'lamb', 'wolf', 'wolf', 'wolf'], 0.16666666666666666]);
        (yield [['wolf', 'wolf', 'lamb', 'lamb', 'lamb'], ['lamb', 'lamb', 'wolf', 'wolf', 'wolf'], -1.0]);
        (yield [['lamb', 'lamb', 'wolf', 'wolf', 'wolf'], ['lamb', 'lamb', 'wolf', 'wolf', 'wolf'], 1.0]);
        (yield [[0, 1, 0, 1, 0], [0, 0, 0, 1, 0], 0.6123724356957946]);

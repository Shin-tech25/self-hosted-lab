...
use OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\Homogeneity;
use OCA\Recognize\Vendor\PHPUnit\Framework\TestCase;
use Generator;
/**
 * @group Metrics
 * @covers \OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\Homogeneity
 * @internal
 */
class HomogeneityTest extends TestCase
{
    ...
    public function scoreProvider() : Generator
    {
        ...
        (yield [[0, 1, 2, 3, 4], ['lamb', 'lamb', 'wolf', 'wolf', 'wolf'], 1.0]);
        (yield [[0, 0, 0, 0, 0], ['lamb', 'lamb', 'wolf', 'wolf', 'wolf'], 0.6]);
    }
}

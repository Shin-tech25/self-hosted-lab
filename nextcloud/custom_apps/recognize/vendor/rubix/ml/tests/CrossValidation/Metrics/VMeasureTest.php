...
/**
 * @group Metrics
 * @covers \OCA\Recognize\Vendor\Rubix\ML\CrossValidation\Metrics\VMeasure
 * @internal
 */
class VMeasureTest extends TestCase
{
    ...
    public function scoreProvider() : Generator
    {
        ...
        (yield [[0, 1, 2, 3, 4], ['lamb', 'lamb', 'wolf', 'wolf', 'wolf'], 0.5882352941176471]);
        (yield [[0, 0, 0, 0, 0], ['lamb', 'lamb', 'wolf', 'wolf', 'wolf'], 0.7499999999999999]);
    }
}

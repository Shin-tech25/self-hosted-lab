...
/**
 * @group Tokenizers
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Tokenizers\Word
 * @internal
 */
class WordTest extends TestCase
{
    ...
    public function tokenizeProvider() : Generator
    {
         ...
         * Russian
         */
        (yield ['Если что-то достаточно важно, вы должны попробовать. Даже если - вероятный исход - неудача.', ['Если', 'что-то', 'достаточно', 'важно', 'вы', 'должны', 'попробовать', 'Даже', 'если', '-', 'вероятный', 'исход', '-', 'неудача']]);
    }
}

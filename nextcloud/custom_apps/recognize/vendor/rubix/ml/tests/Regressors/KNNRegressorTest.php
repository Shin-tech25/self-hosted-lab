...
use OCA\Recognize\Vendor\Rubix\ML\Regressors\KNNRegressor;
...
/**
 * @group Regressors
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Regressors\KNNRegressor
 * @internal
 */
class KNNRegressorTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new KNNRegressor(10, \true, new Minkowski(3.0));
    ...
    {
        $expected = ['k' => 10, 'weighted' => \true, 'kernel' => new Minkowski(3.0)];

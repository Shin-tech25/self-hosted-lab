...
/**
 * @group Regressors
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Regressors\ExtraTreeRegressor
 * @internal
 */
class ExtraTreeRegressorTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new ExtraTreeRegressor(30, 3, 1.0E-7, 4);
    ...
    {
        $expected = ['max height' => 30, 'max leaf size' => 3, 'min purity increase' => 1.0E-7, 'max features' => 4];

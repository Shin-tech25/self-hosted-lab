...
use OCA\Recognize\Vendor\Rubix\ML\Regressors\KDNeighborsRegressor;
...
/**
 * @group Regressors
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Regressors\KDNeighborsRegressor
 * @internal
 */
class KDNeighborsRegressorTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new KDNeighborsRegressor(5, \true, new KDTree());

...
/**
 * @group Datasets
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Datasets\Unlabeled
 * @internal
 */
class UnlabeledTest extends TestCase
{
    ...
    public function filter() : void
    {
        ...
        $expected = [['nice', 'furry', 'friendly', 4.0], ['nice', 'rough', 'friendly', 2.6], ['mean', 'rough', 'friendly', -1.0], ['nice', 'rough', 'friendly', 2.9]];
    ...
    {
        $expected = [['nice', 'furry', 'friendly', 4.0], ['mean', 'furry', 'loner', -1.5], ['nice', 'rough', 'friendly', 2.6], ['mean', 'rough', 'friendly', -1.0], ['nice', 'rough', 'friendly', 2.9], ['nice', 'furry', 'loner', -5.0]];

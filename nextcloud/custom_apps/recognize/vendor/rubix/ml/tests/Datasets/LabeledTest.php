...
namespace OCA\Recognize\Vendor\Rubix\ML\Tests\Datasets;
...
/**
 * @group Datasets
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Datasets\Labeled
 * @internal
 */
class LabeledTest extends TestCase
{
    protected const SAMPLES = [['nice', 'furry', 'friendly', 4.0], ['mean', 'furry', 'loner', -1.5], ['nice', 'rough', 'friendly', 2.6], ['mean', 'rough', 'friendly', -1.0], ['nice', 'rough', 'friendly', 2.9], ['nice', 'furry', 'loner', -5.0]];
    protected const LABELS = ['not monster', 'monster', 'not monster', 'monster', 'not monster', 'not monster'];
    protected const TYPES = [DataType::CATEGORICAL, DataType::CATEGORICAL, DataType::CATEGORICAL, DataType::CONTINUOUS];
    protected const WEIGHTS = [1, 1, 2, 1, 2, 3];
    ...
    {
        $expected = [['nice', 'friendly', 4.0], ['mean', 'loner', -1.5], ['nice', 'friendly', 2.6], ['mean', 'friendly', -1.0], ['nice', 'friendly', 2.9], ['nice', 'loner', -5.0]];
    ...
    {
        $expected = [DataType::categorical(), DataType::categorical(), DataType::categorical(), DataType::continuous()];
    ...
    {
        $expected = [DataType::categorical(), DataType::categorical(), DataType::categorical(), DataType::continuous(), DataType::categorical()];
    ...
    {
        $this->assertEquals(['not monster', 'monster'], $this->dataset->possibleOutcomes());
    }
    /**
     * @test
     */
    ...
    public function filter() : void
    {
        ...
        $samples = [['nice', 'furry', 'friendly', 4.0], ['nice', 'rough', 'friendly', 2.6], ['mean', 'rough', 'friendly', -1.0], ['nice', 'rough', 'friendly', 2.9]];
    ...
    public function join() : void
    {
        ...
        $dataset = new Unlabeled([[1], [2], [3], [4], [5], [6]]);
    ...
    public function sort() : void
    {
        ...
        $expected = [['nice', 'furry', 'loner', -5.0], ['mean', 'furry', 'loner', -1.5], ['mean', 'rough', 'friendly', -1.0], ['nice', 'rough', 'friendly', 2.6], ['nice', 'rough', 'friendly', 2.9], ['nice', 'furry', 'friendly', 4.0]];
    ...
    {
        $expected = [['offset' => 0, 'type' => 'categorical', 'num categories' => 2, 'probabilities' => ['nice' => 0.6666666666666666, 'mean' => 0.3333333333333333]], ['offset' => 1, 'type' => 'categorical', 'num categories' => 2, 'probabilities' => ['furry' => 0.5, 'rough' => 0.5]], ['offset' => 2, 'type' => 'categorical', 'num categories' => 2, 'probabilities' => ['friendly' => 0.6666666666666666, 'loner' => 0.3333333333333333]], ['offset' => 3, 'type' => 'continuous', 'mean' => 0.3333333333333333, 'variance' => 9.792222222222222, 'standard deviation' => 3.129252661934191, 'skewness' => -0.4481030843690633, 'kurtosis' => -1.1330702741786107, 'range' => 9.0, 'min' => -5.0, '25%' => -1.375, 'median' => 0.8, '75%' => 2.825, 'max' => 4.0], ['offset' => 4, 'type' => 'categorical', 'num categories' => 2, 'probabilities' => ['not monster' => 0.6666666666666666, 'monster' => 0.3333333333333333]]];
    ...
    {
        $expected = ['not monster' => [['offset' => 0, 'type' => 'categorical', 'num categories' => 1, 'probabilities' => ['nice' => 1]], ['offset' => 1, 'type' => 'categorical', 'num categories' => 2, 'probabilities' => ['furry' => 0.5, 'rough' => 0.5]], ['offset' => 2, 'type' => 'categorical', 'num categories' => 2, 'probabilities' => ['friendly' => 0.75, 'loner' => 0.25]], ['offset' => 3, 'type' => 'continuous', 'mean' => 1.125, 'variance' => 12.776875, 'standard deviation' => 3.574475485997911, 'skewness' => -1.0795676577113944, 'kurtosis' => -0.7175867765792474, 'range' => 9.0, 'min' => -5.0, '25%' => 0.6999999999999993, 'median' => 2.75, '75%' => 3.175, 'max' => 4.0], ['offset' => 4, 'type' => 'categorical', 'num categories' => 1, 'probabilities' => ['not monster' => 1.0]]], 'monster' => [['offset' => 0, 'type' => 'categorical', 'num categories' => 1, 'probabilities' => ['mean' => 1]], ['offset' => 1, 'type' => 'categorical', 'num categories' => 2, 'probabilities' => ['furry' => 0.5, 'rough' => 0.5]], ['offset' => 2, 'type' => 'categorical', 'num categories' => 2, 'probabilities' => ['friendly' => 0.5, 'loner' => 0.5]], ['offset' => 3, 'type' => 'continuous', 'mean' => -1.25, 'variance' => 0.0625, 'standard deviation' => 0.25, 'skewness' => 0.0, 'kurtosis' => -2.0, 'range' => 0.5, 'min' => -1.5, '25%' => -1.375, 'median' => -1.25, '75%' => -1.125, 'max' => -1.0], ['offset' => 4, 'type' => 'categorical', 'num categories' => 1, 'probabilities' => ['monster' => 1.0]]]];
    ...
    {
        $expected = [['nice', 'furry', 'friendly', 4.0, 'not monster'], ['mean', 'furry', 'loner', -1.5, 'monster'], ['nice', 'rough', 'friendly', 2.6, 'not monster'], ['mean', 'rough', 'friendly', -1.0, 'monster'], ['nice', 'rough', 'friendly', 2.9, 'not monster'], ['nice', 'furry', 'loner', -5.0, 'not monster']];

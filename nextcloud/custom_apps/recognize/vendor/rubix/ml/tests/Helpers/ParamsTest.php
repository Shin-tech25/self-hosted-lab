...
/**
 * @group Helpers
 * @covers \OCA\Recognize\Vendor\Rubix\ML\Helpers\Params
 * @internal
 */
class ParamsTest extends TestCase
{
    ...
    public function ints() : void
    {
        ...
        foreach ($values as $value) {
            $this->assertThat($value, $this->logicalAnd($this->greaterThanOrEqual(0), $this->lessThanOrEqual(100)));
        }
    }
    /**
     * @test
    ...
    {
        (yield [['learning_rate' => 0.1, 'alpha' => 0.0001, 'priors' => null], ', ', 'learning_rate: 0.1, alpha: 0.0001, priors: null']);
        (yield [[new KNearestNeighbors(5), 1.0, 0.8], ', ', '0: K Nearest Neighbors (k: 5, weighted: false, kernel: Euclidean), 1: 1, 2: 0.8']);
        (yield [[1, [2, 3, 4], 5], ' - ', '0: 1 - 1: [0: 2, 1: 3, 2: 4] - 2: 5']);
    }
    /**
     * @test
     */

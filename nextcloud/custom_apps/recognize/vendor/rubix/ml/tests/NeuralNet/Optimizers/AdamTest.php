...
/**
 * @group Optimizers
 * @covers \OCA\Recognize\Vendor\Rubix\ML\NeuralNet\Optimizers\Adam
 * @internal
 */
class AdamTest extends TestCase
{
    ...
    {
        (yield [new Parameter(Matrix::quick([[0.1, 0.6, -0.4], [0.5, 0.6, -0.4], [0.1, 0.1, -0.7]])), Matrix::quick([[0.01, 0.05, -0.02], [-0.01, 0.02, 0.03], [0.04, -0.01, -0.5]]), [[0.003162277660168379, 0.00316227766016838, -0.003162277660168379], [-0.003162277660168379, 0.003162277660168379, 0.0031622776601683794], [0.003162277660168379, -0.003162277660168379, -0.00316227766016838]]]);
    }
}

 ...
 * @covers \OCA\Recognize\Vendor\Rubix\ML\NeuralNet\ActivationFunctions\ReLU
 * @internal
 */
class ReLUTest extends TestCase
{
    ...
    public function computeProvider() : Generator
    {
        ...
        (yield [Matrix::quick([[-0.12, 0.31, -0.49], [0.99, 0.08, -0.03], [0.05, -0.52, 0.54]]), [[0.0, 0.31, 0.0], [0.99, 0.08, 0.0], [0.05, 0.0, 0.54]]]);
    }
    /**
     * @test
    ...
    public function differentiateProvider() : Generator
    {
        ...
        (yield [Matrix::quick([[-0.12, 0.31, -0.49], [0.99, 0.08, -0.03], [0.05, -0.52, 0.54]]), Matrix::quick([[0.0, 0.31, 0.0], [0.99, 0.08, 0.0], [0.05, 0.0, 0.54]]), [[0, 1, 0], [1, 1, 0], [1, 0, 1]]]);
    }
}

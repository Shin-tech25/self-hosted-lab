 ...
 * @covers \OCA\Recognize\Vendor\Rubix\ML\NeuralNet\ActivationFunctions\LeakyReLU
 * @internal
 */
class LeakyReLUTest extends TestCase
{
    ...
    {
        (yield [Matrix::quick([[1.0, -0.5, 0.0, 20.0, -10.0]]), [[1.0, -0.005, 0.0, 20.0, -0.1]]]);
        (yield [Matrix::quick([[-0.12, 0.31, -0.49], [0.99, 0.08, -0.03], [0.05, -0.52, 0.54]]), [[-0.0012, 0.31, -0.0049], [0.99, 0.08, -0.0003], [0.05, -0.005200000000000001, 0.54]]]);
    }
    /**
     * @test
    ...
    {
        (yield [Matrix::quick([[1.0, -0.5, 0.0, 20.0, -10.0]]), Matrix::quick([[1.0, -0.005, 0.0, 20.0, -0.1]]), [[1.0, 0.01, 0.01, 1.0, 0.01]]]);
        (yield [Matrix::quick([[-0.12, 0.31, -0.49], [0.99, 0.08, -0.03], [0.05, -0.52, 0.54]]), Matrix::quick([[-0.0012, 0.31, -0.0049], [0.99, 0.08, -0.0003], [0.05, -0.005200000000000001, 0.54]]), [[0.01, 1.0, 0.01], [1.0, 1.0, 0.01], [1.0, 0.01, 1.0]]]);
    }
}

...
class LogisticRegression implements Estimator, Learner, Online, Probabilistic, RanksFeatures, Verbose, Persistable
{
    ...
    public function train(Dataset $dataset) : void
    {
        ...
        $this->network = new FeedForward(new Placeholder1D($dataset->numFeatures()), [new Dense(1, $this->l2Penalty, \true, new Xavier1())], new Binary($classes, $this->costFn), $this->optimizer);
    ...
    public function proba(Dataset $dataset) : array
    {
        ...
        foreach ($activations as $activation) {
            $probabilities[] = [$classA => 1.0 - $activation, $classB => $activation];
        }

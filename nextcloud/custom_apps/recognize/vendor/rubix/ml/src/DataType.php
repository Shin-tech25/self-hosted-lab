...
class DataType implements Stringable
{
     ...
     * @var literal-string[]
     */
    protected const TYPE_STRINGS = [self::OTHER => 'other', self::CONTINUOUS => 'continuous', self::CATEGORICAL => 'categorical', self::IMAGE => 'image'];
    /**
     * An array of all the high-level data type codes.
     *
     * @var list<int>
     */
    protected const ALL = [self::CONTINUOUS, self::CATEGORICAL, self::IMAGE, self::OTHER];
    /**

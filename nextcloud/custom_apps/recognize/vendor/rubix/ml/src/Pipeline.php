...
class Pipeline implements Online, Probabilistic, Scoring, Persistable, EstimatorWrapper
{
     ...
     *
     * @var list<\OCA\Recognize\Vendor\Rubix\ML\Transformers\Transformer>
     */
    ...
    /**
     * @param \OCA\Recognize\Vendor\Rubix\ML\Transformers\Transformer[] $transformers
     * @param Estimator $base
     * @param bool $elastic
     * @throws InvalidArgumentException
     */
    public function __construct(array $transformers, Estimator $base, bool $elastic = \true)
    {
    ...
    {
        return ['transformers' => $this->transformers, 'estimator' => $this->base, 'elastic' => $this->elastic];
    }
    /**
    ...
    {
        return $this->base instanceof Learner ? $this->base->trained() : \true;
    }
    /**
    ...
    public function proba(Dataset $dataset) : array
    {
        ...
        if (!$this->base instanceof Probabilistic) {
            throw new RuntimeException('Base Estimator must' . ' implement the Probabilistic interface.');
        }
    ...
    public function score(Dataset $dataset) : array
    {
        ...
        if (!$this->base instanceof Scoring) {
            throw new RuntimeException('Base Estimator must' . ' implement the Scoring interface.');
        }

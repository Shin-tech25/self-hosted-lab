...
class Momentum implements Optimizer, Adaptive
{
    ...
    public function step(Parameter $param, Tensor $gradient) : Tensor
    {
        ...
        $velocity = $gradient->multiply($this->rate)->add($velocity->multiply(1.0 - $this->decay));
    ...
    {
        return "Momentum (rate: {$this->rate}, decay: {$this->decay}," . ' lookahead: ' . Params::toString($this->lookahead) . ')';
    }
}

...
class SELU implements ActivationFunction
{
     ...
     * @var float
     */
    public const ALPHA = 1.6732632423543772;
    /**
     * The scaling coefficient.
     *
     * @var float
     */
    public const SCALE = 1.0507009873554805;
    /**
    ...
    {
        return $input > 0.0 ? self::SCALE * $input : self::BETA * (\exp($input) - 1.0);
    }
    /**
     * @internal
     *
    ...
    {
        return $output > 0.0 ? self::SCALE : self::SCALE * ($output + self::ALPHA);
    }
    /**

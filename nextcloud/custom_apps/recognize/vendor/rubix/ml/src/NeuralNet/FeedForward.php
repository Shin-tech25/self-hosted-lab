...
class FeedForward implements Network
{
     ...
     *
     * @var list<\OCA\Recognize\Vendor\Rubix\ML\NeuralNet\Layers\Hidden>
     */
    ...
    /**
     * @param Input $input
     * @param \OCA\Recognize\Vendor\Rubix\ML\NeuralNet\Layers\Hidden[] $hidden
     * @param Output $output
     ...
     *
     * @return list<\OCA\Recognize\Vendor\Rubix\ML\NeuralNet\Layers\Hidden>
     */

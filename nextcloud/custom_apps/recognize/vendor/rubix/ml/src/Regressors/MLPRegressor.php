...
class MLPRegressor implements Estimator, Learner, Online, Verbose, Persistable
{
     ...
     */
    public function __construct(array $hiddenLayers = [], int $batchSize = 128, ?Optimizer $optimizer = null, float $l2Penalty = 0.0001, int $epochs = 1000, float $minChange = 0.0001, int $window = 5, float $holdOut = 0.1, ?RegressionLoss $costFn = null, ?Metric $metric = null)
    {
    ...
    public function train(Dataset $dataset) : void
    {
        ...
        $hiddenLayers[] = new Dense(1, $this->l2Penalty, \true, new Xavier2());
        $this->network = new FeedForward(new Placeholder1D($dataset->numFeatures()), $hiddenLayers, new Continuous($this->costFn), $this->optimizer);

...
class EstimatorType implements Stringable
{
     ...
     * @var literal-string[]
     */
    protected const TYPE_STRINGS = [self::CLASSIFIER => 'classifier', self::REGRESSOR => 'regressor', self::CLUSTERER => 'clusterer', self::ANOMALY_DETECTOR => 'anomaly detector'];
    /**
     * An array of all the estimator type codes.
     *
     * @var list<int>
     */
    protected const ALL = [self::CLASSIFIER, self::REGRESSOR, self::CLUSTERER, self::ANOMALY_DETECTOR];
    /**

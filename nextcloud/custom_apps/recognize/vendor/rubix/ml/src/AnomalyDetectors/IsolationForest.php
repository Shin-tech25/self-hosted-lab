...
class IsolationForest implements Estimator, Learner, Scoring, Persistable
{
     ...
     *
     * @var \OCA\Recognize\Vendor\Rubix\ML\Graph\Trees\ITree[]
     */
    ...
    {
        return ['estimators' => $this->estimators, 'ratio' => $this->ratio, 'contamination' => $this->contamination];
    }
    /**
    ...
    public function train(Dataset $dataset) : void
    {
        ...
        $p = $this->ratio ? \max(self::MIN_SUBSAMPLE, (int) \round($this->ratio * $n)) : \min(self::DEFAULT_SUBSAMPLE, $n);

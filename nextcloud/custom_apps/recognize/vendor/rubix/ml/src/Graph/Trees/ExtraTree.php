...
abstract class ExtraTree extends DecisionTree
{
     ...
     */
    public function __construct(int $maxHeight, int $maxLeafSize, float $minPurityIncrease, ?int $maxFeatures)
    {
    ...
    protected function split(Labeled $dataset) : Split
    {
        ...
        return new Split($bestColumn, $bestValue, $bestGroups, $bestImpurity, $m);
    }
}

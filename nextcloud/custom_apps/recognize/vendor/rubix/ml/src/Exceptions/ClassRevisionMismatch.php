...
use const OCA\Recognize\Vendor\Rubix\ML\VERSION;
/** @internal */
class ClassRevisionMismatch extends RuntimeException
{
    ...
    public function __construct(string $createdWithVersion)
    {
        ...
        parent::__construct('Object incompatible with class revision,' . " {$direction}grade to version {$createdWithVersion}.");

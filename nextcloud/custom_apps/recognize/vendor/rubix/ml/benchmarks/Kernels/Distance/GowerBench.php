...
use OCA\Recognize\Vendor\Rubix\ML\Kernels\Distance\Gower;
...
class GowerBench
{
    ...
    public function setUp() : void
    {
        ...
        $this->aSamples = $generator->generate(self::NUM_SAMPLES)->apply($dropValues)->apply($discretize)->samples();
        $this->bSamples = $generator->generate(self::NUM_SAMPLES)->apply($dropValues)->apply($discretize)->samples();
